...
public class DistributedCacheService implements CacheServiceInterface {
	...
	public void delete(long key) {
		...
		if(response.getCode() != 204 || response == null)
		{
			System.out.println("Failed to delete from the cache");
		}
		else
		{
			System.out.println("The key " + key + " is DELETED from " +this.cacheServerUrl );
		}
	...
	@Override
	public void asynchronousWrite(long key, String value) {
